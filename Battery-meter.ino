...
double ReadVoltage()
{
  double multiplier = 0.1875;//0.1875mV resolution
...
double ReadCurrent()
{
  double currentMultiplier = 0.078125;//0.078125mA resolution
...
void secondTick(void *)
{
  ...
  milliamphours += amps * 0.000277777777777777777777777777d;
  counter++;
  dischargeTime++;
  if(counter == 20)
  {
...
void loop(void)
{
  ...
  doc["esr"] = esr;
  doc["mah"] = milliamphours;
  doc["mwh"] = milliwatthours;
  doc["U"] = volts;
  doc["I"] = amps;
  doc["t"] = dischargeTime;
